...
public class Inovice extends AppCompatActivity {
    ...
    public void hideSoftKeyboard() {
        if (Inovice.this.getCurrentFocus() != null) {
            InputMethodManager inm = (InputMethodManager) Inovice.this.getSystemService(INPUT_METHOD_SERVICE);
            assert inm != null;
            inm.hideSoftInputFromWindow(Inovice.this.getCurrentFocus().getWindowToken(), 0);
        }
    }
    ...
    public void onClickSendInvoice(View view) {
        ...
        db.insertBill(CustName, Address, Mobile, Product, Quantity, Rate, GrossTotal, CuttingRate, WagesRate, TransportRate, CuttingValue, WagesValue, TransportValue, totalPay(), PayBy, paidAmount, calcBalanceAmount());
